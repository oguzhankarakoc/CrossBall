-- CrossBall migration 002: club badge metadata + user theme preference

ALTER TABLE users
  ADD COLUMN IF NOT EXISTS theme_preference TEXT DEFAULT 'system';

ALTER TABLE clubs
  ADD COLUMN IF NOT EXISTS badge_primary_color TEXT,
  ADD COLUMN IF NOT EXISTS badge_secondary_color TEXT,
  ADD COLUMN IF NOT EXISTS badge_initials TEXT,
  ADD COLUMN IF NOT EXISTS badge_icon_type TEXT DEFAULT 'shield',
  ADD COLUMN IF NOT EXISTS badge_gradient_style TEXT DEFAULT 'vertical',
  ADD COLUMN IF NOT EXISTS short_name TEXT;

-- Seed badge metadata for all top clubs (105 slug aliases incl. legacy 001 slugs)
WITH badge_seed AS (
  SELECT * FROM (VALUES
...
-- Fallback initials for any top club without a seed match
UPDATE clubs
SET
...
-- Hint RPC used by request-hint edge function (richer fields than find_intersection_players)
