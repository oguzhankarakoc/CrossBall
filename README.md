...
```bash
./scripts/run_migrations.sh              # apply all SQL migrations (through 025)
./scripts/run_migrations.sh 021 025      # security + club identity patch only
